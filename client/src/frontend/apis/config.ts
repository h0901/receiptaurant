...
export const API_PROMPT =
  ...
  `Please provide me with a receipt image. I will extract the following information: 
  ...
  surcharges: A list of any additional charges, exclude any taxes, with the following details:
